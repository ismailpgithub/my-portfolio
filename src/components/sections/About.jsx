...
const About = () => {
  ...
  const backendSkills = ["Nodejs", "Express", "Mongo"]
  return (
                      ...
                      {frontendSkills.map((tech, key)=>(
                        <span 
                          ...
                          className="bg-blue-500/10 text-blue-500 py-1 px-3 rounded-full text-sm hover:bg-blue-500/20 
                                      hover: shadow-[0_2px_8px_fgba(59, 130, 246, 0.2)] transition"       
                          >
                          {tech}
                        </span>
                      ))}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8 ">
                      <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
                          ...
                          <ul className="list-disc list-inside text-gray-300 space-y-2">
                            <li>
                              <strong>B.Tech in Mechanical Engg </strong>- JNTUA University (2017-2021)
                            </li>

                            <li>
                              Web Development, T-SQL, PowerShell 
                            </li>
                          </ul>
                      </div>
                      ...
                      <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
                          ...
                          <div className="space-y-4 text-gray-300">
                            <div>
                              <h4> Software Engineer at Sagility (2022-2024)</h4>
